...
class User(db.Model):
    ...
    pics = db.relationship('Pics', backref='author', lazy=True)

    created_on = db.Column(db.DateTime, default=datetime.utcnow)
    updated_on = db.Column(db.DateTime, onupdate=datetime.utcnow)
    
    def __repr__(self):
        return f"User({self.username}, {self.email}, {self.pics})"
...
class Pics(db.Model):
    ...
    pic_album = db.relationship('Album', backref='author', lazy=True)
...
class Album(db.Model):
    ...
    album_pics = db.relationship('Pics', backref='author', lazy=True)
